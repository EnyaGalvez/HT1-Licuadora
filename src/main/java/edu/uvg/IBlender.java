...
public interface IBlender {
     ...
     * 
     * @param prod A string representing the product the user is filling the blender
     *             with.
     * @return None
     ...
     *         No value is returned since the operation modifies the internal state
     *         of the blender.
     **/
     ...
     *         This method checks whether the blender has reached its maximum
     *         capacity.
     **/
